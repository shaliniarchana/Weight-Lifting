    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-red-900 to-black relative overflow-hidden px-4 font-russoone tracking-wide text-center">
      ...
      {showPopup && (
        <div className="absolute inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50 animate-fade-in">
          <div className="glitch-text text-shadow-xl" data-text="READY TO BATTLE">
            READY TO BATTLE
          </div>
        </div>
      )}
      ...
      <div
        className={`relative max-w-md w-full bg-black bg-opacity-70 rounded-3xl p-8 shadow-2xl fire-glow-border animate-fade-in scale-up ${
          showPopup ? "blur-sm" : ""
        }`}
      >
        ...
        <label htmlFor="name" className="block mb-2 font-semibold text-red-300 text-center">
          Match Name
        </label>
        <input
          id="name"
        ...
        <label htmlFor="date" className="block mb-2 font-semibold text-red-300 text-center">
          Match Date
        </label>
        <DatePicker
          id="date"
        ...
        <label htmlFor="time" className="block mb-2 font-semibold text-red-300 text-center">
          Starting Time
        </label>
        <TimePicker
          id="time"
